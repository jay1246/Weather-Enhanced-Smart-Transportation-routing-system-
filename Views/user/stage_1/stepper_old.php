...
<div class="containerprogress d-flex justify-content-center mt-2">
    ...
    <ul class="progressbar">
        ...
        <li class="<?= ($occupation_check == 1) ? 'activei' : '' ?>">
            <a class="<?= $class_Occupation ?>" href="<?= ($occupation_check == 1) ? $URL_Occupation : "#"; ?>">
                Occupation
            </a>
        </li>
        ...
        <li class="<?= ($personal_details_check == 1) ? 'activei' : '' ?>">
            <a class=" <?= $class_Personal ?>" href="<?= ($occupation_check == 1 || $personal_details_check == 1) ? $URL_Personal_Details : '#'; ?>">
                Personal Details
            </a>
        </li>
        ...
        <li class="<?= ($contact_details_check == 1) ? 'activei' : '' ?>">
            <a class="<?= $class_Contact_Details ?>" href="<?= ($personal_details_check == 1 || $contact_details_check == 1) ? $URL_Contact_Details :  '#'; ?>">
                Contact Details
            </a>
        </li>
        ...
        <li class="<?= ($identification_details_check == 1) ? 'activei' : '' ?>">
            <a class="<?= $class_identification ?>" href="<?= ($contact_details_check == 1 || $identification_details_check == 1) ? $URL_identification : '#' ?>">
                Identification
            </a>
        </li>
        ...
        <li class="<?= ($usi_details_check == 1) ? 'activei' : '' ?>">
            <a class="<?= $class_USI ?>" href="<?= ($identification_details_check == 1 || $usi_details_check == 1) ? $URL_USI : "#" ?>">
                USI & Avetmiss
            </a>
        </li>
        ...
        <li class="<?= ($education_and_employment_check == 1) ? 'activei' : '' ?>">
            <a class="<?= $class_education_employment_details ?>" href="<?= ($usi_details_check == 1 || $education_and_employment_check == 1) ? $URL_education_employment_details : '#' ?>">
        ...
        <li class="<?= ($Review_Confirm_check == 1) ? 'activei' : '' ?>">
            <a class="<?= $class_application_preview ?>" href="<?= ($education_and_employment_check == 1 || $Review_Confirm_check == 1) ? $URL_application_preview : '#' ?>">
                Review & Confirm
            </a>
        </li>
        ...
        <li class="<?= ($Applicant_Declaration_check == 1) ? 'activei' : '' ?>">
            <a class="<?= $class_applicant_declaration ?>" href="<?= ($Review_Confirm_check == 1 || $Applicant_Declaration_check == 1) ? $URL_applicant_declaration : "#" ?>">
        ...
        <li class="<?= (Stepper_isComplete("documents", $ENC_pointer_id) == 1) ? 'activei' : '' ?>">
            <a href="<?php
                        if (Stepper_isComplete("documents", $ENC_pointer_id) == 1) {
                            echo  base_url('user/stage_1/upload_documents/' . $ENC_pointer_id);
                        } ?>" class="<?php if (url_is('user/stage_1/upload_documents')) {
                                            echo 'text-warning';
                                        } else {
                                            echo 'text-dark';
                                        } ?>">Upload Documents </a>
