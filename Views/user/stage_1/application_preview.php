...
<div class="container-fluid  mt-4 mb-4">
    ...
    <div class="row">
        ...
        <!-- center div  -->
        <div class="col-md-12 bg-white shadow p-0">
            ...
            <div class="row mt-4 ">
                <br>
                <div id="tital_date" class="col-md-6 col-xs-12 ">
                    Date :- <?= date("d/m/Y") ?>
                </div>
                <div id="tital_name" class="col-md-6 col-xs-12">
                    Applicant Name:- <?= $personal_details['first_or_given_name'] . " " . $personal_details['middle_names'] . " " . $personal_details['surname_family_name'] ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 float-end">
                    <div class="profile_image ">
                        <p class="text-center"> Passport photo </p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-borderless table-hover w-80 table-striped print-friendly">
                        ...
                        <?php if (!empty($occupation['current_visa_category'])) { ?>
                            <tr>
                                ...
                                <td class="w-10"><span class="">:</span></td>
                                <td class="w-25"><?= ch($occupation['current_visa_category'], 200) ?></td>
                            </tr>
                        <?php } ?>
                            ...
                            <tr>
                                ...
                                <td class="w-25">
                                    ...
                                    if (!empty($personal_details['surname_family_name'])) {
                                        echo m_name($personal_details['surname_family_name']);
                                    } else {
                                        echo "Not Applicable";
                                    }  ?>
                                </td>
                ...
                <div class="d-flex justify-content-center mt">
                    <table class="table table-borderless table-hover w-100  table-striped print-friendly">
                        ...
                        <tr>
                            ...
                            <td class="w-10">:</td>
                            <td class="w-25"> +<?= country_phonecode($contact_details['mobile_number_code']) ?> <?= m_mobile($contact_details['mobile_number']) ?></td>
                        </tr>
                        <?php if (!empty($contact_details['alter_mobile'])) { ?>
                            <tr>
                                ...
                                <td class="w-10">:</td>
                                <td class="w-25"> +<?= country_phonecode($contact_details['alter_mobile_code']) ?> <?= m_mobile($contact_details['alter_mobile']) ?> </td>
                            </tr>
                        <?php  } ?>
                        <tr>
                        ...
                        <?php if (!empty($contact_details['unit_flat_number'])) { ?>
                            <tr>
                                ...
                                <td class="w-10"><span class="">:</span></td>
                                <td class="w-25"><?= m_mobile($contact_details['unit_flat_number']) ?></td>
                            </tr>
                        <?php } ?>
                        <tr>
                            <td class="w-40">Street / lot Number </td>
                            <td class="w-10"><span class="">:</span></td>
                            <td class="w-25"><?= m_mobile($contact_details['street_lot_number']) ?></td>
                        </tr>
                        ...
                        <?php } else { ?>
                            ...
                            <?php if (!empty($contact_details['postal_postcode'])) { ?>
                                <tr>
                                    <td class="w-40">Postcode</td>
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"><?= m_mobile($contact_details['postal_postcode']) ?></td>
                                </tr>
                            <?php } ?>
                        ...
                        <?php if (!empty($contact_details['emergency_mobile'])) { ?>
                            <tr>
                                <td class="w-40">Mobile Number </td>
                                <td class="w-10"><span class="">:</span></td>
                                <td class="w-25"> +<?= country_phonecode($contact_details['emergency_mobile_code']) ?> <?= m_mobile($contact_details['emergency_mobile']) ?></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
                ...
                <div class="d-flex justify-content-center mt">
                    <table class="table table-borderless table-striped  w-100 table-striped print-friendly">
                        ...
                        <!-- <tr>
                                ...
                                <tr>
                                    <td class="w-40">Place of Birth</td>
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"><?= ucwords(m_name($identification_details['place_of_birth'])) ?></td>
                                </tr>
                                <tr>
                                    <td class="w-40">Current Citizenship</td>
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"><?= $identification_details['current_citizenship'] ?></td>
                                </tr> -->

                        <tr>
                            <td class="w-40">Place of Issue / Issuing Authority</td>
                            <td class="w-10"><span class="">:</span></td>
                            <td class="w-25"> <?= m_name($identification_details['place_of_issue']) ?></td>
                        </tr>

                        <tr>
                            <td class="w-40">Passport Number</td>
                            <td class="w-10"><span class="">:</span></td>
                            <td class="w-25"><?= passport_number($identification_details['passport_number']) ?></td>
                        </tr>

                        <tr>
                            <td class="w-40"> Passport Expiry Date </td>
                            <td class="w-10"><span class="">:</span></td>
                            <td class="w-25"> <?= m_date($identification_details['expiry_date']) ?></td>
                        </tr>
                    </table>
                </div>
                <hr style="text-align: center;" width="100%">
                            ...
                            if ($usi_details['currently_have_usi'] == "yes") { ?>
                                <?php if (!empty($usi_details['usi_no'])) { ?>
                                    <tr>
                                        ...
                                        <td class="w-10"><span class="">:</span></td>
                                        <td class="w-25"><?= USI_number($usi_details['usi_no']) ?></td>
                                    </tr>
                                <?php } ?>
                        ...
                        <table class="table table-borderless table-striped  w-100 table-striped print-friendly">
                            <?php if (!empty($register_user['name'])) { ?>
                                <tr>
                                    ...
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"><?= m_name($register_user['name']) ?> <?= m_name($register_user['last_name']) ?> </td>
                                </tr>
                            <?php } ?>
                            ...
                            <?php if (!empty($register_user['mobile_code'])) { ?>
                                <tr>
                                    ...
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"> +<?= country_phonecode($register_user['mobile_code']) ?> <?= m_mobile($register_user['mobile_no']) ?></td>
                                </tr>
                            <?php } ?>
                            <?php if (!empty($register_user['tel_code']) && !empty($register_user['tel_no'])) { ?>
                                <tr>
                                    ...
                                    <td class="w-25"> +<?= country_phonecode($register_user['tel_code']) ?> <?php if (!empty($register_user['area_code'])) {
                                                                                                                echo m_mobile($register_user['tel_area_code']);
                                                                                                            } ?> <?= m_mobile($register_user['tel_no']) ?></td>
                                </tr>
                            <?php } ?>
                            <?php if (!empty($register_user['unit_flat'])) { ?>
                                <tr>
                                    <td class="w-40"> Unit / Flat Number </td>
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"> <?= m_mobile($register_user['unit_flat']) ?></td>
                                </tr>
                            <?php } ?>
                            <?php if (!empty($register_user['street_lot'])) { ?>
                                <tr>
                                    <td class="w-40"> Street / Lot number </td>
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"> <?= m_mobile($register_user['street_lot']) ?></td>
                                </tr>
                            <?php } ?>
                            <?php if (!empty($register_user['street_name'])) { ?>
                                <tr>
                                    <td class="w-40"> Street Name </td>
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"> <?= m_name($register_user['street_name']) ?></td>
                                </tr>
                            <?php } ?>
                            ...
                            <?php if (!empty($register_user['postcode'])) { ?>
                                <tr>
                                    <td class="w-40"> postcode </td>
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"> <?= m_mobile($register_user['postcode']) ?></td>
                                </tr>
                            <?php } ?>
                                ...
                                <?php } else {  ?>
                                    ...
                                    <?php if (!empty($register_user['postal_unit_flat'])) { ?>
                                        <tr>
                                            <td class="w-40"> Unit / Flat Number </td>
                                            <td class="w-10"><span class="">:</span></td>
                                            <td class="w-25"> <?= m_mobile($register_user['postal_unit_flat']) ?></td>
                                        </tr>
                                    <?php } ?>
                                    <?php if (!empty($register_user['postal_street_lot'])) { ?>
                                        <tr>
                                            <td class="w-40"> Street / Lot number </td>
                                            <td class="w-10"><span class="">:</span></td>
                                            <td class="w-25"> <?= m_mobile($register_user['postal_street_lot']) ?></td>
                                        </tr>
                                    <?php } ?>
                                    <?php if (!empty($register_user['postal_street_name'])) { ?>
                                        <tr>
                                            <td class="w-40"> Street Name </td>
                                            <td class="w-10"><span class="">:</span></td>
                                            <td class="w-25"> <?= m_name($register_user['postal_street_name']) ?></td>
                                        </tr>
                                    <?php } ?>
                                    ...
                                    <?php if (!empty($register_user['postal_suburb_city'])) { ?>
                                        <tr>
                                            <td class="w-40"> Suburb / City </td>
                                            <td class="w-10"><span class="">:</span></td>
                                            <td class="w-25"> <?= m_name($register_user['postal_suburb_city']) ?></td>
                                        </tr>
                                    <?php } ?>
                                    <?php if (!empty($register_user['postal_state_province'])) { ?>
                                        <tr>
                                            <td class="w-40"> State / Province </td>
                                            <td class="w-10"><span class="">:</span></td>
                                            <td class="w-25"> <?= strtoupper(m_name($register_user['postal_state_province'])) ?></td>
                                        </tr>
                                    <?php } ?>
                                    <?php if (!empty($register_user['postal_postcode'])) { ?>
                                        <tr>
                                            <td class="w-40"> Postcode </td>
                                            <td class="w-10"><span class="">:</span></td>
                                            <td class="w-25"> <?= m_mobile($register_user['postal_postcode']) ?></td>
                                        </tr>
                                    <?php } ?>
                    ...
                    <table class="table table-borderless table-hover  table-striped  w-100 print-friendly">
                        ...
                        <?php if (!empty($usi_details['Please_indicate_area_NOTE'])) { ?>
                            <tr>
                                ...
                                <td class="w-10"><span class="">:</span></td>
                                <td class="w-25"><?= preg_replace('/[^A-Za-z0-9\-]/', ' ', ch($usi_details['Please_indicate_area_NOTE'], 255)) ?></td>
                            </tr>
                        <?php } ?>
                        ...
                        <?php if (!empty($usi_details['require_additional_support'])) { ?>
                            ...
                            <?php if ($usi_details['require_additional_support'] == 'yes') { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="w-10"><span class="">:</span></td>
                                    <td class="w-25"><?= preg_replace('/[^A-Za-z0-9\-]/', ' ', ch($usi_details['note'], 255)) ?></td>
                                </tr>
                                <!-- <?php } ?> -->
                            <?php } ?>
                        <?php } ?>
                        ...
                        <?php if (!empty($education_and_employment['highest_completed_school_level'])) { ?>
                            ...
                            <?php if ($usi_details['speak_english_at_home'] == 'yes') { ?>
                                <?php if (!empty($usi_details['specify_language'])) { ?>
                                    ...
                                    <!--    <td class="w-40"> Specify language </td>-->
                                    <!--    <td class="w-10"><span class="">:</span></td>-->
                                    <!--    <td class="w-25"><?= m_name(ucwords(ch($usi_details['specify_language'], 255))) ?></td>-->
                                    <!--</tr>-->
                                <?php } ?>
                                <?php if (!empty($usi_details['proficiency_in_english'])) { ?>
                                    <!--<tr>-->
            ...
            <div class="text-end mb-4" id="download_pdf">
                <a href="<?= base_url('user/download_PDF_/' . $ENC_pointer_id) . '/' . urlencode('TRA Application Form - Preview') ?>" class="btn btn_green_yellow" onclick="pdf_Download_check_('review_confirm_pdf_download')">Download Application Preview</a>
            </div>
            <?php
            if (!session()->has('check_admin')) {
            ?>
                <div class="text-center mt-4 mb-3">
                    <a href="<?= base_url('user/stage_1/education_employment_details/' . $ENC_pointer_id) ?>" class="btn btn_yellow_green">Back</a>
                    <a href="<?= base_url('user/dashboard') ?>" class="btn btn_green_yellow"> Save & Exit </a>
                    <a id="next" href="<?= base_url('user/stage_1/applicant_declaration/' . $ENC_pointer_id) ?>" class="btn btn_yellow_green">Next</a>
                </div>
            <?php } ?>
        </div>
...
function your_func() {
    ...
    function pdf_Download_check_(file_page) {
        $.ajax({
            data: {
    ...
    // store in sql PDF table-------------------
    function pdf_html_code_(Form_data) {
       
        $('#download_pdf').hide(1000);
        ...
        $.ajax({
            ...
            type: 'post',
            url: '<?= base_url('user/pdf_html_code_'); ?>',
            error: function() {
                // alert('PDF Download is OFF ');
                $('#download_pdf').hide(1000);
            },
            success: function(data) {
                // alert(data);
                $('#download_pdf').show(1000);
    ...
    $('#pdf').click(function() {
        ...
        htmlString = htmlString.replace('style="font-size: 23px;"', '');
        pdf_html_code_(htmlString);
    });
    ...
    $(document).ready(function() {
        ...
        htmlString = htmlString.replace('style="font-size: 23px;"', '');
        pdf_html_code_(htmlString);
        // pass P_id and File name to run this funtion 
        pdf_Download_check_('review_confirm_pdf_download');
    });
</script>
<script>
    $(document).ready(function() {
        var width = $(window).width();
        (width <= 600) ? $('#tital_date').addClass('text-center'): $('#tital_date').addClass('text-end');
        (width <= 600) ? $('#tital_name').addClass('text-center'): $('#tital_name').addClass('text-left');
    });
</script>


<?php
function ch($name, $lanth)
{
    // $name =  substr($name, 0, $lanth);
    // $name = ucfirst(strtolower($name));
    return $name;
}
function m_date($name)
{
...
function m_mobile($Mobile)
{
    // $Mobile =  substr($Mobile, 0, 16);
    return $Mobile;
}
function passport_number($passport_number)
{
    // $passport_number = str_replace(' ', '', $passport_number); // Replaces all spaces with hyphens.
    // $passport_number = preg_replace('/[^A-Za-z0-9\-]/', '', $passport_number); // Removes special chars
    // // $passport_number =  substr($passport_number, 0, 20);
    // $passport_number = strtoupper($passport_number);
    return $passport_number;
}
function USI_number($USI_no)
{
    // $USI_no = str_replace(' ', '', $USI_no); // Replaces all spaces with hyphens.
    // $USI_no = preg_replace('/[^A-Za-z0-9\-]/', '', $USI_no); // Removes special chars
    // // $USI_no =  substr($USI_no, 0, 10);
    // $USI_no = strtoupper($USI_no);
    return $USI_no;
}
?>
<?= $this->endSection() ?>