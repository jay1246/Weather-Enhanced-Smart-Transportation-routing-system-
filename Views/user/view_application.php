...
<div class="container-fluid mt-4 mb-4 p-4 bg-white shadow">
    ...
    if ($is_employe_add) {  // continu stage 2
        ...
        // vishal 29-05-2023 
        if ($stage_index == 5  || $stage_index == 11 || $stage_index == 49) {
    ...
    if ($stage_index == 12  || $stage_index >= 12 && $stage_index <= 18) {
    ...
    // if($stage_index == 15 || $stage_index >= 16 && $stage_index < 30){
    //       $s2_active = "active";
    //       $s2_show = "show active";
    // }
// echo "gghgf";
...
<!--echo $s3_active;-->
    ...
    <div class="row nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <?php 
        //echo $stage_index.$s2_active.$s2_show;
        ...
        <?php if (!empty($s1_show)) { ?>
            <div class="tab-pane fade <?= $s1_show ?>  bg-white shadow- p-3" id="stage_1" role="tabpanel" aria-labelledby="stage_1-tab">
                ...
                if (isset($stage_1['approved_date']) && !empty($stage_1['approved_date']) && $stage_1['approved_date'] != "0000-00-00 00:00:00" && $stage_1['approved_date'] != null) {
                    $Expired_date =  date('Y-m-d', strtotime('+60 days', strtotime($stage_1['expiry_date'])));
                    ...
                    <div class="col-sm-6">
                        ...
                        <table class="table">
                            <thead>
                                        ...
                                        <td>
                                            <b>
                                                ...
                                                <?php
                                                    ...
                                                    $increase_30_days = 0;
                                                    $expiry_date__ = $stage_1['expiry_date'];
                                                    if($stage_1['closure_date'] != "0000-00-00 00:00:00"){
                                                        $expiry_date__ = $stage_1['closure_date'];
                                                    }
                                                    $date1 = new DateTime(date('Y-m-d', strtotime('0 days', strtotime($expiry_date__))));
                                                    ...
                                                    // $day_remain = $day_remain_expiry_checker;
                                ...
                                <?php 
                                    if (isset($stage_1['omitted_date']) && !empty($stage_1['omitted_date'])) { 
                                ?>
                                    <tr>
                                        <th>
                                            Date Omitted
                                        ...
                                        <td>
                                            <?php
                                                if (!empty($stage_1['omitted_date']) && $stage_1['omitted_date'] != "0000-00-00 00:00:00" && $stage_1['omitted_date'] != null) {
                                                echo date("d/m/Y", strtotime($stage_1['omitted_date']));
                                                } 
                                                ?>
                                        </td>
                                    </tr>
                                ...
                                ?>
                                        <tr>
                                         ...
                                         <?php $stage_2_expier = find_one_row('application_pointer', 'id', $stage_1['pointer_id']);
                                               if (empty($stage_2_expier->status) || $stage_2_expier->status == "Start") {  ?>
                                        <!--<tr>-->
                                        <!--    <th>-->
                                        ...
                                        <!--    <td>-->
                                        <!--        <php-->
                                        <!--        if (!empty($stage_1['expiry_date']) && $stage_1['expiry_date'] != "0000-00-00 00:00:00" && $stage_1['expiry_date'] != null) {-->
                                ...
                                if ($stage_index < 12) {  ?>
                                    ...
                                    $interval = $date1->diff($date2);
                                    // echo "difference " . $interval->y . " years, " . $interval->m." months, ".$interval->d." days "; 
                                    $day_remain_ = $interval->days;
                                    if ($date2 > $date1) {
                                        // If $date2 is greater than $date1, make $day_remain_ negative
                                        $day_remain_ = -$day_remain_;
                                    }
                                    $day_remain = $day_remain_;
                                    // echo $day_remain_." - ds";
                                    // exit;
                                    ?>
                                        ...
                                        <?php if (isset($stage_1['status']) && $stage_1['status'] == "Approved" || $stage_1['status'] == "Archive" || $stage_1['status'] == "Expired") { ?>
                                            <?php if (isset($stage_1['expiry_date']) && !empty($stage_1['expiry_date'])) { ?>
                                                <?php if (!empty($stage_1['expiry_date']) && $stage_1['expiry_date'] != "0000-00-00 00:00:00" && $stage_1['expiry_date'] != null) { ?>
                                                    <?php if(empty($stage_1['closure_date']) || $stage_1['closure_date'] == "0000-00-00 00:00:00"){
                                                    ?>
                                                        <tr>
                                                            <th>
                                                                <?php
                                                            ...
                                                            <td> <!-- 25-04-2023 vishal patel  -->
                                                                <?= date('d/m/Y', strtotime($stage_1['expiry_date']));  ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> <!-- 25-04-2023 vishal patel  -->
                                            <?php 
                                                echo date('d/m/Y', strtotime("+".$increase_30_days." days", strtotime($stage_1['expiry_date'])));
                                                // echo  date('d/m/Y', strtotime($stage_1['expiry_date']));
                                                // echo $day_remain;
                                            ?>
                                            </td>
                                ...
                                <!-- Closure Date -->
                                <?php
                                if (!empty($stage_1['closure_date']) && $stage_1['closure_date'] != "0000-00-00 00:00:00" && $stage_1['closure_date'] != null) {
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if (!empty($stage_1['closure_date']) && $stage_1['closure_date'] != "0000-00-00 00:00:00" && $stage_1['closure_date'] != null) {
                                                        // Old Code Checking
                                                        // echo date("d/m/Y", strtotime($stage_1['closure_date']));
                                                        echo  date('d/m/Y', strtotime("+".$increase_30_days." days", strtotime($stage_1['closure_date'])));
                                                    } ?>
                                                </td>
                                            </tr>
                                            <?php 
                                            ...
                                            $interval = $date1->diff($date2);
                                            // echo "difference " . $interval->y . " years, " . $interval->m." months, ".$interval->d." days "; 
                                            $day_remain_closure = $interval->days;
                                            if ($date2 > $date1) {
                                                // If $date2 is greater than $date1, make $day_remain_ negative
                                                $day_remain_closure = -$day_remain_closure;
                                            }
                                            // echo $day_remain_closure;
                                            if($day_remain_closure >= 0){
                                            ?>
                                            <tr>
                                                <td colspan="2">
                                                    <div class="p-2 bg-yellow text-green rounded">
                                                        <b>The application will be closed permanently if the Stage 2 is not submitted by <?= date("d/m/Y", strtotime($stage_1['closure_date'])) ?></b>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php 
                                ...
                                <!-- END -->
                                    ...
                                    <?php if (isset($stage_1['status']) && $stage_1['status'] == "Archive" || $stage_1['status'] == "Expired") { ?>
                                        ...
                                        <?php if($stage_1['closure_date'] == '0000-00-00 00:00:00'){ ?>
                                            <tr>
                                                <td colspan="2">
                                                    <div class="p-2 bg-yellow rounded">
                                                        Kindly reach out on
         ...
         <?php
        // echo $stage_index;
                  if($stage_index == 5 || $stage_index==11 || $stage_index==50){
                                            $pointer_id = pointer_id_decrypt($ENC_pointer_id);
                                           $data =find_one_row('stage_2_add_employment','pointer_id', $pointer_id);
                                           
                                           if(!$data){
                                               $val="Start Stage 2 Submission";
                                           }else{
                                               $val="Continue Stage 2 Submission";
                                           }
                                           
                                       //  print_r($data);
                                        //   echo "hello".$pointer_id.$stage_index;
                                              ?>
                                   <?php if(!$data){ ?>
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header" id="s1_tital_div">
                                    <?php $docs_expiry =find_one_row('documents','pointer_id', $pointer_id);  
                                    if(!empty($docs_expiry)){
                                    ?>
                    ...
                    <?php
                //       if($stage_index == 5  || $stage_index == 6 || $stage_index == 7){
                //         $pointer_id = pointer_id_decrypt($ENC_pointer_id);
                //         $stage = $value['stage'];
                //         if($stage == 'stage_1') {
                //           delete_by_pointer_id__($pointer_id,$stage);
                //         }
                         
                //   }
                    if ($stage_index >= 2 && $stage_index <= 4) {  ?>
        ...
        <?php if (!empty($s2_show)) { ?>
           ...
           <div class="tab-pane fade <?= $s2_show ?> bg-white shadow p-3" id="stage_2" role="tabpanel" aria-labelledby="stage_2-tab">
                <div class="row mt-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <table class="table <?= (isset($stage_2) && empty($stage_2)) ? "d-none " : ""; ?>">
                            <thead>
                                ...
                                <?php } ?>
                                 <!-- closed  date -->
                                <?php if (isset($stage_2['closed_date']) && !empty($stage_2['closed_date'])) { ?>
                                    <tr>
                                        <th>
                                            Date Closed
                                        </th>
                                        <td>
                                            <?= date('d/m/Y', strtotime("+".$increase_30_days." days", strtotime($stage_2['closed_date']))); ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row " >
                        <?php if (isset($stage_2['status']) && $stage_2['status'] != 'Closed') { ?>
                                <div class="col-sm-6  mb-2">
                                    <a href="<?= base_url('public/assets/PDF/Stage%202%20Applicant%20Checklist.pdf') ?>" class="btn btn_green_yellow w-100" download="">Download Stage 2 Checklist <i class="bi bi-download "></i></a>
                                </div>
                                <?php }?>
                                    ...
                                    if ($Application_Details['pathway'] == "Pathway 1") {
                                      ...
                                      if (isset($stage_2['status']) && $stage_2['status'] != 'Closed') {
                    ...
                    <?php 
                //     if( $stage_index >= 15 && $stage_index <= 17 ){
                //         $pointer_id = pointer_id_decrypt($ENC_pointer_id);
                //         $stage = $value['stage'];
                //         if($stage == 'stage_2') {
                //           delete_by_pointer_id__($pointer_id,$stage);
                ...
                //   }
                    if (isset($stage_2['status']) &&  $stage_2['status'] != "Start") { ?>
                                            ...
                                            <div class="card-body bg-white  w-100 col-sm-12">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($documents as $key => $value) {
                                                            ...
                                                            // }
                                                                if ($value['stage'] == "stage_2") {
                                                                    ...
                                                                    // echo $value['required_document_id'];
                                                                    if ($value['required_document_id']== 15|| $value['required_document_id']==30 ||$value['required_document_id']==17|| $value['required_document_id']==34 || $value['required_document_id']==53 || $value['required_document_id']==56 || $value['required_document_id']==57  ) {
                                                                       $required_document_id = $value['required_document_id'];
                                                                        $employee_id = $value['employee_id'];
                                                                        if ($employee_id == 0 || empty($employee_id)) {
                                                                            $show_f = true;
                                                        ...
                                                        $additional_eve = getdataforsupporetingevidance_user_side($pointer_id);
                                                        if ($additional_eve) {
                    ...
                    foreach ($additional_info_request as $key__ => $value__) {
                        ...
                        if ($stage__ == "stage_2" && $status__ == "send" &&  $stage_index >= 12 && $stage_index <= 14 ) {
                                ...
                                <table class="table">
                                        ...
                                        //  
                                            ...
                                            // if (!empty($request_document_id)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="file" class="form-control" name="file[]" accept=".pdf" value="" required />
                                                        <div class="text-danger col-sm-6 ">
                                                            Only : .pdf                                                                        
                                                        </div>
                                                        <input type="hidden" name="add_req_id[]" value="<?= $value->id ?>">
                                    ...
                                    <?php
                                            ...
                                            <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="file" class="form-control" name="file[]" required accept=".jpg,.jpeg,.heif,.mp4,.mkv,.pdf"/>
                                                                        <div class="text-danger col-sm-6 ">
                                                                            Only : .jpg / .jpeg / .heif / .mp4 / .mkv / .pdf                                                             </div>
                                                                        <input type="hidden" name="add_req_id[]" value="<?= $value->id ?>">
                                                                        <input type="hidden" name="send_by" value="<?= $value->send_by ?>">
                                                                        <input type="hidden" name="document_id[]" value="<?= $value->document_id ?>">
                                                                        <input type="hidden" name="stage" value="stage_2">
        ...
        <?php if (!empty($s3_show)) { ?>
            <div class="tab-pane fade <?= $s3_show ?>  bg-white shadow- p-3" id="stage_3" role="tabpanel" aria-labelledby="stage_3-tab">
                <div class="row mt-3">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($documents as $key => $value) {
                                                        // print_r($documents);
                                                        if ($value['stage'] == "stage_3") {
                                                            if ($value['required_document_id'] == 19 || $value['required_document_id'] == 29 || $value['required_document_id'] == 43 || $value['required_document_id'] == 55 || $value['required_document_id'] == 0) {
                                                                $show_f = true;
                                                                $documnet_request = find_one_row('additional_info_request', 'document_id', $value['id']);
                                                                if (!empty($documnet_request)) {
                                                                    if (isset($documnet_request->status)) {
                    ...
                    <!-- Interview Schedule -->
                    <?php
                   // print_r($Interview_Schedule_cancle);
                    if (isset($stage_3["status"])) {
                        if ($stage_3["status"] == 'Scheduled' || $stage_3["status"] == '') {
                    ...
                    <?php } ?>
                      ...
                      <!-- INTERVIEW CANCLE BY ROHIT stage3 -->
                      <?php 
                      
                      if(($Interview_Schedule_cancle) && $stage_index == 23){ ?>
                <div class="container">
  <div class="row">
     ...
     <table class="table">
        <thead>
          <tr>
            <td style="width: 30%; border-bottom: 0px; margin-top:10px" colspan="2">
              <br>
              <u> <b style="color: #055837;"> Interview Booking Details - (Cancelled)</b></u> <br>
            </td>
          </tr>
             <tr style="background-color: #ffc107; border: 1px solid green; border-radius: 15px;">
              ...
              <div style="background-color: #ffc107;">
                ...
                <table id="sddsf">
                  <tbody >
                     <tr>
                      <td>
                        <b style="color:red">Date Cancelled</b>
                      </td>
                      <td style="width: 20px; padding-left: 34px;" >:</td>
                      <td style="padding-left: 20px; color:red" >
                        <?php
                       
                        echo $time_date = date('d/m/Y', strtotime($Interview_Schedule_cancle['cancle']));
                     ...
                     <tr>
                        ...
                        <td style="width: 20px;  padding-left: 34px;">:</td>
                        <td style="padding-left: 20px; color:red">
                          <?= $Interview_Schedule_cancle['interview_comment'] ?>
                        </td>
                        </tr>
                  </tbody>
                </table>
          ...
          <tr style="background-color: #ffc107 !important;border: 1px solid green; border-radius: 15px;">
            <td colspan="2" style="background-color: #ffc107;">
              <div style="background-color: #ffc107;">
                <style>
                  #sddsf td {
                ...
                <table id="sddsf">
                  <tbody>
                      ...
                      <td>
                        <!-- time 1  -->
                        <?php
                        $time_date = date('Y-m-d H:i:s', $Interview_Schedule_cancle['tmsp']);
                        $date = new DateTime($time_date, new DateTimeZone('Australia/Brisbane'));
                        $time_date_n = $date->format('Y-m-d H:i:s');
                        echo  $date->format('l, jS F Y') . ' / ' . $date->format('h:i A');
                        ?>
                        ...
                        <!-- time 2  -->
                        <?php
                        if ($Interview_Schedule_cancle['venue'] != 'Australia/Brisbane') {
                        ?>

                          <?php
                          $date->setTimezone(new DateTimeZone($Interview_Schedule_cancle['date_time_zone']));
                          echo  $date->format('l, jS F Y') . ' / ' . $date->format('h:i A');
                          ?>
                          (<?= $Interview_Schedule_cancle['date_time_zone'] ?> Time)
                    ...
                    <tr>
                      ...
                      <td style="width: 20px;">:</td>
                      <td>
                        <?= $Interview_Schedule_cancle['venue'] ?>
                      </td>
                    </tr>
                    
                    <?php
                    if ($Interview_Schedule_cancle['venue']  != "Online (Via Zoom)") {
                    ?>
                      <tr>
                        <td>
                          <b> Location </b>
                        ...
                        <td style="width: 20px;">:</td>
                        <td>
                          <?= $Interview_Schedule_cancle['office_address'] ?>,
                          <?= $Interview_Schedule_cancle['country'] ?>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
                  ...
                  <?php  }?>
                    ...
                    <?php 
                //       if( $stage_index >= 25 && $stage_index <= 29 ){
                //         $pointer_id = pointer_id_decrypt($ENC_pointer_id);
                //         $stage = $value['stage'];
                //         if($stage == 'stage_3') {
                //           delete_by_pointer_id__($pointer_id,$stage);
                ...
                //   }
                    ...
                    if ($stage_index >= 22 && $stage_index <= 26) {  ?>
                        ...
                        foreach ($stage_3_data as $key_1 => $value_1) {
                            $stage = $value_1->stage;
                            $status = $value_1->status;
                            if ($stage == "stage_3" && $status == "send" && $stage_index >= 22 && $stage_index <= 26) {
                                $show_Additional_Information_Request = true;
                            }
                        }
                        ...
                        <?php } ?>
                    <?php } ?>
                    <!-- stage 3_ress Action Requad  -->

                </div>
                <?php 
          //this code for stage3 reassesenment additionalreq use in future by rohit
                    //      if( $stage_index >= 42 && $stage_index <= 48 ){
                    //       $pointer_id = pointer_id_decrypt($ENC_pointer_id);
                    //       $stage = $value['stage'];
                    //       if($stage == 'stage_3_R') {
                    //         delete_by_pointer_id__($pointer_id,$stage);
            ...
            <div class="tab-pane fade <?= $s3_R_show ?>  bg-white shadow- p-3" id="stage_3_r" role="tabpanel" aria-labelledby="stage_3_r-tab">
                <div class="row mt-3">
                    ...
                    if (isset($stage_3_R["status"])) {
                        ...
                        <?php } ?>
                    <?php } ?>
             <!-- INTERVIEW CANCLE BY ROHIT STAGE_R-->
                      <?php 
                    //   print_r($Interview_Schedule_cancle_reass);
                    //   die;
                      if(isset($Interview_Schedule_cancle_reass)&& $stage_index == 42){ ?>
                <div class="container">
  <div class="row">
    <div class="col-md-12 custom-bg">
     <table class="table">
              ...
              <div style="background-color: ##ffc107;">
                ...
                <table id="sddsf">
                  <tbody>
                      ...
                      <td style="width: 20px;  padding-left: 34px;">:</td>
                      <td style="padding-left: 20px; color:red;">
                    <? echo $time_date = date('d/m/Y', strtotime( $Interview_Schedule_cancle_reass['cancle']));  ?>
                    ...
                    <tr>
                        ...
                        <td style="width: 20px;  padding-left: 34px;">:</td>
                        <td style="padding-left: 20px; color:red;">
                          <?= $Interview_Schedule_cancle_reass['interview_comment'] ?>
                        </td>
                      </tr>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <!-- time 1  -->
                        <?php
                        $time_date = date('Y-m-d H:i:s', $Interview_Schedule_cancle_reass['tmsp']);
                        $date = new DateTime($time_date, new DateTimeZone('Australia/Brisbane'));
                        $time_date_n = $date->format('Y-m-d H:i:s');
                        echo  $date->format('l, jS F Y') . ' / ' . $date->format('h:i A');
                        ?>
                        ...
                        <!-- time 2  -->
                        <?php
                        if ($Interview_Schedule_cancle_reass['venue'] != 'Australia/Brisbane') {
                        ?>

                          <?php
                          $date->setTimezone(new DateTimeZone($Interview_Schedule_cancle_reass['date_time_zone']));
                          echo  $date->format('l, jS F Y') . ' / ' . $date->format('h:i A');
                          ?>
                          (<?= $Interview_Schedule_cancle_reass['date_time_zone'] ?> Time)
                    ...
                    <tr>
                      ...
                      <td style="width: 20px;">:</td>
                      <td>
                        <?= $Interview_Schedule_cancle_reass['venue'] ?>
                      </td>
                    </tr>
                    <?php
                    if ($Interview_Schedule_cancle_reass['venue']  != "Online (Via Zoom)") {
                    ?>
                      <tr>
                        <td>
                          <b> Location </b>
                        ...
                        <td style="width: 20px;">:</td>
                        <td>
                          <?= $Interview_Schedule_cancle_reass['office_address'] ?>,
                          <?= $Interview_Schedule_cancle_reass['country'] ?>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
                    ...
                    ?>
                      ...
                      //   echo $stage_index;
                        ...
                        foreach ($stage_3_ress_data as $key_1 => $value_1) {
                            $stage = $value_1->stage;
                            $status = $value_1->status;
                            if ($stage == "stage_3_R" && $status == "send" && $stage_index== 41)  {
                                $show_Additional_Information_Request = true;
                            }
                        }
                        ?>
                        ...
                        <div class="tab-pane fade  <?= $s4_show ?>  bg-white shadow- p-3" id="stage_4" role="tabpanel" aria-labelledby="stage_4-tab">
                            <div class="row ">
                                ...
                                <div class="col-sm-6">
                                                    ...
                                                    <div class="card-body">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                foreach ($documents as $key => $value) {
                                                                    if ($value['stage'] == "stage_4") {
                                                                        if ($value['required_document_id'] == 44 || $value['required_document_id'] == 49 || $value['required_document_id'] == 0) {
                                                                            $show_f = true;
                                                                            $documnet_request = find_one_row('additional_info_request', 'document_id', $value['id']);
                                                                            if (!empty($documnet_request)) {
                                                                                if (isset($documnet_request->status)) {
                                 ...
                                 if( $stage_index >= 34 && $stage_index <= 38 ){
                                    $pointer_id = pointer_id_decrypt($ENC_pointer_id);
                                    $stage = $value['stage'];
                                    if($stage == 'stage_4') {
                                      delete_by_pointer_id__($pointer_id,$stage);
                                 ...
                                 if ($show_stage_4_addition_request) {
    ...
    $(document).ready(function() {
        ...
        $(".add_info_req_stage").submit(function(e) {
            ...
            var stage = formData.get("stage"); 
             var doc_names = formData.getAll("doc_name[]");
            if (doc_names.length === 0 || doc_names.some(name => name.trim() === '')) {
                custom_alert_popup_show('', "Please enter the document name.", 'Ok', 'btn-danger', false); 
                $("#loader-please-wait").hide(); 
                return;
            }
            
            // Check File Size more than 20 MB
            
            doc_names.forEach(doc_name => {
                
                if (doc_name.size > 1024 * 1024 * 20) {
