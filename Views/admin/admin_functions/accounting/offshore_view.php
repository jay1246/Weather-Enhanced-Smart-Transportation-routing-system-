...
<main id="main" class="main" style="width: 100%;">
    <div class="pagetitle">
        <h4 class="text-green">Admin Functions -> Accounting -> Offshores Fees</h4>
    </div>
        ...
        <div class="card card-primary card-outline card-tabs">
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-agent-tab" href="<?= base_url("admin/admin_functions") ?>" role="tab" aria-controls="custom-tabs-agent" aria-selected="false">Reporting</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active active_btn  active" href="<?= base_url("admin/admin_functions/accounting") ?>" id="custom-tabs-applicant-tab" role="tab" aria-controls="custom-tabs-applicant" aria-selected="true">Accounting</a>
                    </li>
                ...
                <select name="pageShow" id="itemsPerPageDropdown" style="float: right;
    margin-top: -35px;
    margin-right: 10px;">
            ...
            <div class="tab-content" id="custom-tabs-three-tabContent">
                ...
                <div class="tab-pane fade show active" id="custom-tabs-agent" role="tabpanel" aria-labelledby="custom-tabs-agent-tab">
                    <div class="card-body table-responsive">
                        <div class="row py-2">
                            <div class="col-12">
                            <a href="<?= base_url("admin/admin_functions/accounting") ?>" class="btn btn_yellow_green" style="background-color: white;border: 2px solid;">
                                Referral Fees
                            </a>

                            <a href="<?= base_url("admin/admin_functions/accounting/offshore") ?>" class="btn btn_green_yellow">
                                Offshores Fees
                            </a>
                            ...
                            <div class="col-12 px-2">
                                <div class="row g-0">
                                    <div class="col-9">
                                        <div class="row gx-1">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select name="interview_location" id="interview_location" class="form-select" onchange="search_filter()">
                                                    <option value="">All</option>
                                                    <?php 
                                                    foreach($locations as $location){
                                                        ?>
                                                        <option value="<?= $location["id"] ?>"><?= $location["city_name"]." - ".$location["country"] ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <!-- <div class="col-3 tooltip-wrapper">
                                    ...
                                    <div class="col-3" style="margin-top: 23px;">
                                        ...
                                        <a href="<?= base_url("admin/admin_functions/accounting/offshore") ?>" class="btn btn_yellow_green" id="__clear_btn" data-toggle="tooltip" data-placement="top" title="Refresh">
...
<script>
        ...
        var search_input = '';
        var search_flag = "";
        var from_date = to_date = stage = status = prn = applicant_no = agent = d_o_b = occupation = agent_id = pathway = interview_location ="";
        // Accounting Filter
        stage = "stage_3";
        status = "lodged";
        // 
    ...
    function load_data(page = 1) {
            ...
            $.ajax({
                url: "<?= base_url('admin/admin_functions/accounting/fetch_application_records_offshore'); ?>",
                method: "GET",
                data: {
                    page: page,
    ...
    function load_agent_data(page=1){
            $("#agent_tooltip").html('');
            $.ajax({
                url: "<?= base_url('admin/admin_functions/accounting/fetch_application_records_agent_offshore'); ?>",
                method: "GET",
                data: {
                    page: page,
                    itemsPerPage: itemsPerPage,
        ...
        function _export_to_pdf(page=1){
            $('#cover-spin').show(0);
            $.ajax({
                url: "<?= base_url('admin/admin_functions/accounting/download_report_offshore'); ?>",
                method: "GET",
                data: {
                    page: page,
                    itemsPerPage: itemsPerPage,
        ...
        function _export_to_spreadsheet(page=1){
            $('#cover-spin').show(0);
            $.ajax({
                url: "<?= base_url('admin/admin_functions/accounting/download_report_spreadsheet_offshore'); ?>",
                method: "GET",
                data: {
                    page: page,
                    itemsPerPage: itemsPerPage,
        ...
        function __changeDropdown(stage){
            ...
            var options_html = "<option value=''>All</option>";
