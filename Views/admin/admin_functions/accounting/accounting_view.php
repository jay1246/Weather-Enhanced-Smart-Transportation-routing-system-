...
<main id="main" class="main" style="width: 100%;">
    <div class="pagetitle">
        <h4 class="text-green">Admin Functions -> Accounting -> Referral Fees</h4>
    </div>
            ...
            <div class="tab-content" id="custom-tabs-three-tabContent">
                ...
                <div class="tab-pane fade show active" id="custom-tabs-agent" role="tabpanel" aria-labelledby="custom-tabs-agent-tab">
                    <div class="card-body table-responsive">
                        <div class="row py-2">
                            <div class="col-12">
                            <a href="<?= base_url("admin/admin_functions/accounting") ?>" class="btn btn_green_yellow">
                                Referral Fees
                            </a>

                            <a href="<?= base_url("admin/admin_functions/accounting/offshore") ?>" class="btn btn_yellow_green" style="background-color: white;border: 2px solid;">
                                Offshores Fees
                            </a>
                            ...
                            <div class="col-12 px-2">
                                <div class="row g-0">
                                    ...
                                    <div class="col-3" style="margin-top: 23px;">
                                        ...
                                        <a href="<?= base_url("admin/admin_functions/accounting") ?>" class="btn btn_yellow_green" id="__clear_btn" data-toggle="tooltip" data-placement="top" title="Refresh">
...
<script>
        ...
        var search_input = '';
        var search_flag = "";
        var from_date = to_date = stage = status = prn = applicant_no = agent = d_o_b = occupation = agent_id = pathway = "";
        // Accounting Filter
        stage = "stage_3";
        status = "lodged";
        // 
    ...
    function search_filter() {
        ...
        function load_data(page = 1) {
            ...
            $.ajax({
                url: "<?= base_url('admin/admin_functions/accounting/fetch_application_records'); ?>",
                method: "GET",
                data: {
                    page: page,
        ...
        function load_agent_data(page=1){
            $("#agent_tooltip").html('');
            $.ajax({
                url: "<?= base_url('admin/admin_functions/accounting/fetch_application_records_agent'); ?>",
                method: "GET",
                data: {
                    page: page,
                    itemsPerPage: itemsPerPage,
        ...
        function _export_to_pdf(page=1){
            $('#cover-spin').show(0);
            $.ajax({
                url: "<?= base_url('admin/admin_functions/accounting/download_report'); ?>",
                method: "GET",
                data: {
                    page: page,
                    itemsPerPage: itemsPerPage,
        ...
        function _export_to_spreadsheet(page=1){
            $('#cover-spin').show(0);
            $.ajax({
                url: "<?= base_url('admin/admin_functions/accounting/download_report_spreadsheet'); ?>",
                method: "GET",
                data: {
                    page: page,
                    itemsPerPage: itemsPerPage,
