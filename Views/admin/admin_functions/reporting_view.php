        ...
        <div class="card card-primary card-outline card-tabs">
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="  nav-link " id="custom-tabs-applicant-tab" role="tab" aria-controls="custom-tabs-applicant" aria-selected="true">Accounting</a>
                    </li>
                                ...
                                <div class="row g-0">
                                    <div class="col-9">
                                        <div class="row gx-1">
                                            ...
                                            <div class="col-4 tooltip-wrapper">
...
<script>
        ...
        var search_input = '';
        var search_flag = "";
        var from_date = to_date = stage = status = prn = applicant_no = agent = d_o_b = occupation = agent_id = "";
        load_data();
