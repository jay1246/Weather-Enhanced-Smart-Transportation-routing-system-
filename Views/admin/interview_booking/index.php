                    ...
                    <table id="interview_booking_table" class="table table-striped datatable table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($interview_bookings as $booking) {
                                ...
                                $stage_3 = find_one_row('stage_3', 'pointer_id', $booking->pointer_id);
                                                ...
                                                <div class="modal-content" style="background-color: white;">
                                                    <form class="edit_data" action="" method="post" id="edit_data<?= $booking->id ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-12 mt-2">
                                                                <b> <label>Date <span class="text-danger">*</span></label> </b>
                                                                <input name="date" type="date" class="form-control" value="<?= date('Y-m-d', strtotime($booking->date_time)) ?>">
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="text-end">
                                                                <button type="button" class="btn btn_yellow_green" onclick="hide_model_box('edit_data<?= $booking->id ?>')" data-bs-dismiss="modal">Close</button>
