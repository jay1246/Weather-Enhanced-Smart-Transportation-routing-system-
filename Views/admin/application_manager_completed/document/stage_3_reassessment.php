...
<?php if ($show) { ?>
    <div class="accordion mt-1" id="document_stage_3_reassessment">
            ...
            <div id="doc_stage_3_reassessment" class="accordion-collapse collapse" aria-labelledby="doc_head_stage_3_reassessment" data-bs-parent="#document_stage_3_reassessment">
                <div class="accordion-body">
                    <div id="download_div" class="mb-2">
                        <a onclick="download_zip(<?= $pointer_id ?>,'stage_3_R')" class="disabled btn_yellow_green btn"> Download All Stage 3 (Reassessment) Documents <i class="bi bi-download"></i></a>
                    </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($stage_3_reassessment_documents as $s3_document_r) {
                                    ...
                                    $main_validator = check_file_closed($application_pointer, (array)$s3_document_r);
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <td class="w-50">
                                                <a class="normal_link" <?= $full_url_target ?> href="<?= $full_url ?>"> <?= $s3_document_r->name  ?> </a>
                                            </td>
                                            <td style="text-align: center;">
                                                ...
                                                ?>
                                                <!-- Delete  -->
                                                <a onclick="delete_document(<?= $s3_document_r->id ?>)" class="disabled btn btn-sm btn-danger">
                                                    <i class="bi bi-trash-fill"></i>
                                                </a>
                                                <!-- comment  -->
                                                <a href="javascript:void(0)" class="disabled btn <?= $s3_r_disabled_comment ?> btn-sm btn_green_yellow" id="Dbtn_s3_r_<?= $count ?>" onclick="show_input_s3_r('<?= $count ?>')">
                                                    <i class="bi bi-chat-left-dots"></i>
                                                </a>
                                                <a href="javascript:void(0)" style="display: none;" id="Xbtn_s3_r_<?= $count ?>" class="disabled btn btn_yellow_green btn-sm" onclick="show_input_s3_r('<?= $count ?>')">
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <a href="javascript:void(0)" class="disabled btn btn-sm btn-sm btn_green_yellow" id="Dbtn_s3_Additional" onclick="show_input_s3_r('Additional')">
                                        <i class="bi bi-chat-left-dots"></i>
                                    </a>
                                    <a href="javascript:void(0)"  class="disabled btn btn-sm btn_yellow_green" style="display: none;" id="Xbtn_s3_Additional" onclick="show_input_s3_r('Additional')">
                                        <i class="bi bi-x-lg"></i>
                                    </a>
                                </td>
                                <td>
                                ...
                                if($checks1->status != 'Approved'){
                                    ...
                                    ?>
                                    <td colspan="3">
                                        <button type="submit" class="disabled btn btn_green_yellow" style="display: none; float:right" id="s3_r_doc_sub_btn" <?=$disable?>>Request Additional Info</button>
                                    </td>
                                </tr>
                                <?php  }?>
                            </tbody>
