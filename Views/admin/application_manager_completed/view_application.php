...
<main id="main" class="main w-100">
            ...
            <div class="card-header p-0 pt-1 border-bottom-0">
                ...
                <ul class="nav nav-pills nav-fill" style="margin-right: 15px;margin-left: 15px;margin-top: 20px;width: 98%;">
                   ...
                   <li class="nav-item" class="ps-2">
                        <a class="nav-link shadow-sm text-center tab text-color <?=$notes?>"
                            id="notes_tab" href="<?= base_url("admin/application_manager_completed/view_application/" . $pointer_id . "/notes") ?>" role="tab" aria-controls="notes_tab" aria-selected="false">  Notes</a>
                    </li>
                  </ul> 
            ...
            <div class="tab-content">
                ...
                <div  class="tab-pane fade show <?= $view_tab ?>" id="view_view_edit" role="tabpanel" aria-labelledby="tabs_view_edit">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                        echo $this->include("admin/application_manager_completed/view_update/applicant_data.php");
                        ?>
                        <!--  -------------------End Applicant details ---------------- -->

                        <!--  -------------------Stage 1 - Self Assessment ---------------- -->
                        <?php if ($stage_1 != "") {
                            echo $this->include("admin/application_manager_completed/view_update/stage_1.php");
                        } ?>
                        ...
                        if ($stage_2 != "") {
                            if (!empty($stage_2->status) and $stage_2->status != 'Start') {
                                echo $this->include("admin/application_manager_completed/view_update/stage_2.php");
                            }
                        } ?>
                        ...
                        if ($stage_3 != "") {
                            if (!empty($stage_3->status) and $stage_3->status != 'Start') {
                                echo $this->include("admin/application_manager_completed/view_update/stage_3.php");
                            }
                        } ?>
                        ...
                        if ($stage_3_reassessment != "") {
                            if (!empty($stage_3_reassessment->status) and $stage_3_reassessment->status != 'Start' and $stage_3_reassessment->status != 'reassessment') {
                                echo $this->include("admin/application_manager_completed/view_update/stage_3_reassessment.php");
                            }
                        } ?>
                        <!--  -------------------End stage 3 Documentary Evidence ---------------- -->
                         ...
                         if (!empty($stage_4)) {
                                ...
                                if($pathway=="Pathway 1"){
                                    if($s1_occupation->occupation_id==7||$s1_occupation->occupation_id==18){
                                     ...
                                     echo $this->include("admin/application_manager_completed/view_update/stage_4.php");
                                    }
                                }
                         }
                        // if ($stage_4 != "") {
                        ...
                        //              echo $this->include("admin/application_manager_completed/view_update/stage_4.phpdd
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($stage_1 != "") {
                            if (!empty($stage_1->status)) {
                                if ($stage_1->status != "Start") {
                                    echo $this->include("admin/application_manager_completed/document/stage_1.php");
                                }
                            }
                        } ?>
                        ...
                        <?php if ($stage_2 != "") {
                            if (!empty($stage_2->status)) {
                                if ($stage_2->status != "Start") {
                                            echo $this->include("admin/application_manager_completed/document/stage_2.php");
                        ...
                        if ($stage_3 != "") {
                            if (!empty($stage_3->status)) {
                                if ($stage_3->status != "Start") {
                                    // echo $stage_3->status;
                                    // exit;
                                    echo $this->include("admin/application_manager_completed/document/stage_3.php");
                                }
                            }
                        } ?>
                        ...
                        if ($stage_3_reassessment != "") {
                            if (!empty($stage_3_reassessment->status)) {
                                if ($stage_3_reassessment->status != "Start" and $stage_3_reassessment->status != "reassessment") {
                                    // echo $stage_3->status;
                                    // exit;
                                    echo $this->include("admin/application_manager_completed/document/stage_3_reassessment.php");
                                }
                            }
                        } ?>
                        <!-- ------------------stage 3 documents end --------- -->
                        ...
                        <?php
                         if (!empty($stage_4)) {
                                ...
                                if($pathway=="Pathway 1"){
                                    if($s1_occupation->occupation_id==7||$s1_occupation->occupation_id==18){
                                    echo $this->include("admin/application_manager_completed/document/stage_4.php");
                                    }
                                }
                         }
  ...
  <div style="<?=$hide?>" class="tab-pane fade  show <?= $notes ?>" id="notes" role="tabpanel" aria-labelledby="notes_tab">
                    ...
                    <div class="card-body">
         <?=  $this->include("admin/application_manager_completed/view_update/notes.php");?>
 ...
 $( document ).ready(function() {
    ...
    function update_unique_no_stage_1() {
     stage_1_hide_show_btn_team_name_();
        ...
        // return;
        $.post("<?= base_url("admin/application_manager_completed/update_unique_no/stage_1") ?>", {
            pointer_id,
            ...
            if (selete_status != "Select Status"){
                ...
                $("#stage_1_pop_btn").click(function() {
                    ...
                    if (custom_alert_popup_close('stage_1_pop_btn')) {
                        ...
                        $.ajax({
                            method: "POST",
                            url: "<?php echo base_url('admin/application_manager_completed/status_change/stage_1'); ?>",
                            data: formData,
                            processData: false,
                            contentType: false,
        ...
        if (selete_status != "Select Status"){
            ...
            $("#stage_2_pop_btn").click(function() {
                ...
                if (custom_alert_popup_close('stage_2_pop_btn')) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "<?= base_url("admin/application_manager_completed/status_change/stage_2") ?>",
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(data) {
        ...
        if (selete_status != "Select Status"){
            ...
            $("#stage_3_pop_btn").click(function() {
                ...
                if (custom_alert_popup_close('stage_3_pop_btn')) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "<?= base_url("admin/application_manager_completed/status_change/stage_3") ?>",
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(data) {
        ...
        if (selete_status != "Select Status"){
            ...
            $("#stage_3_res_pop_btn").click(function() {
                ...
                if (custom_alert_popup_close('stage_3_res_pop_btn')) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "<?= base_url("admin/application_manager_completed/status_change/stage_3_reassessment") ?>",
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(data) {
    ...
    $("#stage_4_change_status").submit(function(e) {
        ...
        $("#stage_4_pop_btn").click(function() {
            ...
            if (custom_alert_popup_close('stage_4_pop_btn')) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?= base_url("admin/application_manager_completed/status_change/stage_4") ?>",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(data) {
    ...
    //             $.ajax({
    //                 method: "POST",
    //                 url: "<?= base_url("admin/application_manager_completed/comment_document") ?>",
    //                 data: formData,
    //                 processData: false,
    //                 contentType: false,
    //                 success: function(data) {
    ...
    //                     if (data["response"] == true) {
    //                         window.location.reload();
    //                         // window.location = "<?php // base_url("admin/application_manager_completed/view_application/") ?>/"+data['pointer_id']+tab;
    //                     } else {
    //                         alert(data["msg"]);
    //                     }
    //                 }
    ...
    $("#verify_email_stage_1").submit(function(e) {
        ...
        $.ajax({
            method: "POST",
            url: "<?= base_url("admin/application_manager_completed/verify_email_stage_1") ?>",
            data: formData,
            processData: false,
            contentType: false,
            success: function(data) {
    ...
    $("#quali_verify_form").submit(function(e) {
        ...
        $("#stage_1_quali_verfi_emil_pop_btn").click(function() {
            ...
            if (custom_alert_popup_close('stage_1_quali_verfi_emil_pop_btn')) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?= base_url("admin/application_manager_completed/qualification_verification_form") ?>",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(data) {
    ...
    $("#reason_form_stage_2").submit(function(e) {
        ...
        $("#stage_doc_2_pop_btn").click(function() {
            ...
            if (custom_alert_popup_close('stage_doc_2_pop_btn')) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?= base_url("admin/application_manager_completed/comment_document_stage_2") ?>",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(data) {
     ...
     function send_emp_email() {
        ...
        $("#AJDS").click(function() {
            ...
            if (custom_alert_popup_close('AJDS')) {
                $('#cover-spin').show(100);
                $.ajax({
                    url: "<?= base_url('admin/application_manager_completed/send_employ_email_stage_2') ?>",
                    method: "POST",
                    data: {
    ...
    $("#verify_email_stage_2").submit(function(e) {
        ...
        $.ajax({
            method: "POST",
            url: "<?= base_url("admin/application_manager_completed/verify_email_stage_2") ?>",
            data: formData,
            processData: false,
            contentType: false,
            success: function(data) {
    ...
    function delete_document(id) {
        ...
        $("#delete_pop_btn").click(function() {
            if (custom_alert_popup_close('delete_pop_btn')) {
                $('#cover-spin').show(0);
                $.ajax({
                    url: "<?= base_url('admin/application_manager_completed/delete_document') ?>/" + id,
                    method: "POST",
                    data: {
                        "id": id,
                    },
                    success: function(data) {
                        ...
                        if (data["response"] == true) {
                            window.location.reload();
                            // window.location = "<?php // base_url("admin/application_manager_completed/view_application/") ?>/"+pointer_id+'/'+tab;
                        } else {
                            alert(data["msg"]);
                        }
                    },
    ...
    function delete_employe(id) {
        ...
        $("#delete_pop_btn_s2").click(function() {
            if (custom_alert_popup_close('delete_pop_btn_s2')) {
                ...
                $('#cover-spin').show(0);
                $.ajax({
                    url: "<?= base_url('admin/application_manager_completed/delete_company') ?>/" + id,
                    method: "POST",
                    data: {
                        "id": id,
                    },
    ...
    function download_zip(pointer_id, stage) {
        ...
        $("#AJDSAKAJLD").click(function() {
            ...
            if (custom_alert_popup_close('AJDSAKAJLD')) {
                $.ajax({
                    url: "<?= base_url('admin/application_manager_completed/download_zip') ?>/" + pointer_id + '/' + stage,
                    type: "POST",
                    data: {
                        "pointer_id": pointer_id,
                        "stage": stage,
    ...
    function re_create_TRA(noreload = "") {
        ...
        $("#delete_stage2_btn").click(function() {
            if (custom_alert_popup_close('delete_stage2_btn')) {
                $('#cover-spin').show(0);
                $.ajax({
                    url: "<?= base_url('admin/application_manager_completed/delete_stage2') ?>/" + pointer_id,
                    method: "POST",
                    data: {
                        "pointer_id": pointer_id,
                    },
       ...
       custom_alert_popup_show(header = '', 'Are you sure you want to change the occupation?', close_btn_text = 'No', close_btn_css = 'btn-danger', other_btn = true, other_btn_name = 'Yes', other_btn_class = 'btn_green_yellow', other_btn_id = 'AJDSAKAJLD');
           $("#AJDSAKAJLD").click(function() {
            if (custom_alert_popup_close('AJDSAKAJLD')) {
                ...
                $.ajax({
                    url: '<?= base_url('admin/application_manager_completed/chef_to_cook/'. $pointer_id) ?>',
                    type: 'POST',
       ...
       custom_alert_popup_show(header = '', 'Are you sure you want to change the program?', close_btn_text = 'No', close_btn_css = 'btn-danger', other_btn = true, other_btn_name = 'Yes', other_btn_class = 'btn_green_yellow', other_btn_id = 'AJDSAKAJLD');
           $("#AJDSAKAJLD").click(function() {
            if (custom_alert_popup_close('AJDSAKAJLD')) {
                ...
                $.ajax({
                    url: '<?= base_url('admin/application_manager_completed/osap_to_tss/'. $pointer_id) ?>',
                    type: 'POST',
       ...
       custom_alert_popup_show(header = '', 'Are you sure you want to change the pathway?', close_btn_text = 'No', close_btn_css = 'btn-danger', other_btn = true, other_btn_name = 'Yes', other_btn_class = 'btn_green_yellow', other_btn_id = 'AJDSAKAJLD');
           $("#AJDSAKAJLD").click(function() {
            if (custom_alert_popup_close('AJDSAKAJLD')) {
                ...
                $.ajax({
                    url: '<?= base_url('admin/application_manager_completed/pathway_change/'. $pointer_id) ?>',
                    type: 'POST',
