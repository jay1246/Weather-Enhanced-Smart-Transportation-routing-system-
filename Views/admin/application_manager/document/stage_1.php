        ...
        <div id="doc_stage_1" class="accordion-collapse collapse" aria-labelledby="doc_head_stage_1" data-bs-parent="#document_stage_1">
            <div class="accordion-body">
                <div id="download_div" class="mb-2 ">
                    <a onclick="download_zip(<?= $pointer_id ?>,'stage_1')" class="btn_yellow_green btn"> Download All Stage 1 Documents <i class="bi bi-download"></i></a>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($stage_1_documents as $s1_document) {  ?>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td class="w-50">
                                            <a class="normal_link" target="_blank" href="<?= base_url() ?>/<?= $s1_document->document_path ?>/<?= $s1_document->document_name ?>"> <?= $s1_document->name  ?> </a>
                                            <?php
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            if (session()->get('admin_account_type') == 'admin') {
                                                ...
                                                <button type="button" class="btn btn-sm btn_green_yellow" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                            ...
                                            ?>
                                            <!-- Delete  -->
                                            <a onclick="delete_document(<?= $s1_document->id ?>)" class="btn btn-sm btn-danger">
                           ...
                           <?php  if(!empty($agent_auth_form)){ ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <!-- download  -->
                                    <a href="<?= base_url() . '/public/application/' . $pointer_id . '/AgentAuthorisationForm.pdf' ?>" download="" class="btn btn-sm btn_yellow_green"><i class="bi bi-download"></i></a>
                                    <!-- delete  -->
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <?php if (session()->get('admin_account_type') == 'admin') { ?>
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-sm btn_green_yellow" onclick='re_create_TRA()' data-bs-toggle="tooltip" data-bs-html="true" title=" Regenerate TRA Application Form">
