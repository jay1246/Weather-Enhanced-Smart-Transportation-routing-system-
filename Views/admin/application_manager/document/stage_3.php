...
<?php if ($show) { ?>
    <div class="accordion" id="document_stage_3">
            ...
            <div id="doc_stage_3" class="accordion-collapse collapse" aria-labelledby="doc_head_stage_3" data-bs-parent="#document_stage_3">
                <div class="accordion-body">
                    <div id="download_div" class="mb-2">
                        <a onclick="download_zip(<?= $pointer_id ?>,'stage_3')" class="btn_yellow_green btn"> Download All Stage 3 Documents <i class="bi bi-download"></i></a>
                    </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-sm btn-sm btn_green_yellow" id="Dbtn_s3_Additional" onclick="show_input_s3('Additional')">
                                        <i class="bi bi-chat-left-dots"></i>
                                    </a>
                                    <a href="javascript:void(0)"  class="btn btn-sm btn_yellow_green" style="display: none;" id="Xbtn_s3_Additional" onclick="show_input_s3('Additional')">
                                        <i class="bi bi-x-lg"></i>
                                    </a>
                                </td>
                                <td>
                               ...
                               <?php 
                                ...
                                <tr>
                                    <td colspan="3">
                                        <button type="submit" class="btn btn_green_yellow" style="display: none; float:right" id="s3_doc_sub_btn">Request Additional Info</button>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>
