                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <td class="w-50">
                                                <a class="normal_link" target="_blank" href="<?= base_url() ?>/<?= $s4_document->document_path ?>/<?= $s4_document->document_name ?>"> <?= $s4_document->name ?> </a>
                                            </td>
                                            <td style="text-align: center;">
                                                <!-- download  -->
                                                <a href="<?= base_url() ?>/<?= $s4_document->document_path  ?>/<?= $s4_document->document_name  ?>" download="" class="btn btn-sm btn_yellow_green"><i class="bi bi-download"></i></a>
                                                <?php
                                                $s3_disabled_comment = "";
                                                ...
                                                ?>
                                                <!-- Delete  -->
                                                <a onclick="delete_document(<?= $s4_document->id ?>)" class="btn btn-sm btn-danger">
                                                    <i class="bi bi-trash-fill"></i>
                                                </a>
                                                <!-- comment  -->
                                                <a href="javascript:void(0)" class="btn <?= $s3_disabled_comment ?> btn-sm btn_green_yellow" id="Dbtn_s4_<?= $count ?>" onclick="show_input_s4('<?= $count ?>')">
                                                    <i class="bi bi-chat-left-dots"></i>
                                                </a>
                                                <a href="javascript:void(0)" style="display: none;" id="Xbtn_s4_<?= $count ?>" class="btn btn_yellow_green btn-sm" onclick="show_input_s4('<?= $count ?>')">
