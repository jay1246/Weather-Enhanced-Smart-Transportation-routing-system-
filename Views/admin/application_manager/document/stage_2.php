                                ...
                                // if($s2_document_ass->required_document_id == 16||$s2_document_ass->required_document_id == 17){
                                  ...
                                  ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-50">
                                                <a class="normal_link" target="_blank" href="<?= base_url() ?>/<?= $s2_document_ass->document_path ?>/<?= $s2_document_ass->document_name ?>"> <?= $s2_document_ass->name  ?> <?= $span_name ?></a>
                                            </td>
                                            <td style="text-align: center;">
                                                ...
                                                <!-- Delete  -->
                                                <a onclick="delete_document(<?= $s2_document_ass->id ?>)" href="javascript:void(0)" class="btn btn-sm btn-danger">
                                                ...
                                                ?>
                                                <!-- comment  -->
                                                <a href="javascript:void(0)" class="btn <?= $s2_disabled_comment ?> <?= $chat_button_disabled ?>  btn-sm btn_green_yellow" id="Dbtn_s2_assessment<?= $sr_no ?>" onclick="show_input_s2('assessment<?= $sr_no ?>')">
                                                    <i class="bi bi-chat-left-dots"></i>
                                                </a>
                                                <a href="javascript:void(0)" style="display: none;" id="Xbtn_s2_assessment<?= $sr_no ?>" class="btn btn_yellow_green btn-sm" onclick="show_input_s2('assessment<?= $sr_no ?>')">
                               ...
                               <!-- Additional Information pooja ----------------------->
                                <tr class="tital_set" style="background-color:white;font-size: 17px;color: #4154f1!important;" id="assmement_additional_row">
                                    ...
                                    <td style="text-align: center; ">
                                        <!-- download  -->
                                        <!-- download  -->
                                        <a herf="" id="add_more_button" class="btn btn-sm btn_yellow_greenn " onclick="add_additional_inforamtion('',<?= $s2_document_ass->pointer_id ?>,'<?= $s2_document_ass->stage ?>','','assmement_additional_row', this,'','input_s2_new_Additional','show_input_s2_',0)" style=" border:0px; background-color: #dec45c; color:#055837 !important">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-sm btn-sm btn_green_yellow pooja" id="new_testing_Additional" onclick="show_input_s2_('Additional')">
                                            <i class="bi bi-chat-left-dots"></i>
                                        </a>
                                        <!--<a href="javascript:void(0)" class="btn btn-sm btn_yellow_green" style="display: none;" id="XXbtn_s2_Additional" onclick="show_input_s2('Additional')">-->
                                        <a href="javascript:void(0)" class="btn btn-sm btn_yellow_green" style="display: none;" id="close_new_Additional" onclick="show_input_s2_('Additional')">
                                            <i class="bi bi-x-lg"></i>
                                        </a>
                                    </td>
                                    <td>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            ?>
                                            <!-- comment  -->
                                            <a href="javascript:void(0)" class="btn <?= $s2_disabled_comment ?>  btn-sm btn_green_yellow" id="DDbtn_s2_<?= $sr_no ?>" onclick="show_input_s2('<?= $sr_no ?>')">
                                                <i class="bi bi-chat-left-dots"></i>
                                            </a>
                                            <a href="javascript:void(0)" style="display: none;" id="XXbtn_s2_<?= $sr_no ?>" class="btn btn_yellow_green btn-sm" onclick="show_input_s2('<?= $sr_no ?>')">
                                                <i class="bi bi-x-lg"></i>
                                            </a>
                                        </td>
                                        <td>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                ?>
                                                <!-- comment  -->
                                                <a href="javascript:void(0)" class="btn <?= $s2_disabled_comment_ ?>  btn-sm btn_green_yellow" id="Dbtn_s2_<?= $sr_no ?>" onclick="show_input_s2('<?= $sr_no ?>')">
                                                    <i class="bi bi-chat-left-dots"></i>
                                                </a>
                                                <a href="javascript:void(0)" style="display: none;" id="Xbtn_s2_<?= $sr_no ?>" class="btn btn_yellow_green btn-sm pp" onclick="show_input_s2('<?= $sr_no ?>')">
                                                    <i class="bi bi-x-lg"></i>
                                                </a>
                                            </td>
                                            <td>
                            ...
                            <!-- Additional Information ----------------------->
                                <tr class="tital_set" style="background-color:white;font-size: 17px;color: #4154f1!important;" id="assmement_support_row">
                                    ...
                                    <td style="text-align: center; ">
                                        <!-- download  -->
                                        <!-- download  -->
                                        <a herf="" id="add_more_button_" class="btn btn-sm btn_yellow_greenn  " style="border: 0px;background-color: #dec45c ;color: #055837 !important;" 
    ...
    <!-------------------------------------------- employees documents -------------------------------------------------------------------------------->
                                ...
                                ?>
                                    <tr class="tital_set here mohsin">
                                        ...
                                        <td style="--bs-table-accent-bg:none; text-align: center;">
                                            <!-- download  -->
                                            <a href="" class=" disabled btn btn-sm btn_yellow_green " style=" border:0px; background-color: #ffe475 !important; color:black !important"><i class="bi bi-download"></i></a>

                                            <!-- Delete  -->
                                            <a onclick="delete_employe(<?= $stage_2_employee->id ?>)" href="javascript:void(0)"  class="btn btn-sm btn-danger" <?= $style ?>>
                                                <i class="bi bi-trash-fill"></i>
                                            </a>
                                            <!-- comment  -->
                                    ...
                                    ?>
                                            ...
                                            ?>
                                                ...
                                                <tr class="Here Employement">
                                                    <!-- <td class="w-50" style="padding-left: 50px;"> -->
                                                    <td class="w-50">
                                                        <a class="normal_link" target="_blank" href="<?= base_url() ?>/<?= $s2_document->document_path ?>/<?= $s2_document->document_name ?>"> <?= $s2_document->name  ?> <?= $span_name ?> </a>
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <!-- download  -->
                                                        ...
                                                        <!-- Delete  -->
                                                        <a onclick="delete_document(<?= $s2_document->id ?>)" href="javascript:void(0)" class="btn btn-sm btn-danger">
                                                            <i class="bi bi-trash-fill"></i>
                                                        </a>
                                                        <!-- comment  -->

                                                        <a href="javascript:void(0)" class="btn btn-sm  btn_green_yellow <?= $chat_button_disabled ?> " id="Dbtn_s2_<?= $sr ."_". $count ?>" onclick="show_input_s2('<?= $sr ."_". $count ?>')">
                                                            <i class="bi bi-chat-left-dots"></i>
                                                        </a>
                                                        <a href="javascript:void(0)" style="display: none;" id="Xbtn_s2_<?= $sr ."_". $count ?>" class="btn btn_yellow_green btn-sm" onclick="show_input_s2('<?= $sr ."_". $count ?>')">
                                                            <i class="bi bi-x-lg"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="reason[]" style="display: none;" onkeyup=check_s2() id="input_s2_<?= $sr ."_". $count ?>" class="form-control s1">
                                ...
                                <tr class="tital_set" style="background-color:white;font-size: 17px;color: #4154f1!important" id="organization_add_row<?= $organization_row_count ?>">
                                    ...
                                    <td style="text-align: center; ">
                                        <!-- download  -->
                                        <!-- download  -->
                                        <a herf="" id="add_more_button__<?= $stage_2_employee->id ?>" class="btn btn-sm btn_yellow_greenn "    onclick="add_additional_inforamtion('',<?= $s2_document->pointer_id ?>,'<?= $s2_document->stage ?>',<?= $stage_2_employee->id ?>,'organization_add_row<?= $organization_row_count ?>', this, '','input_s2_Additional_<?= $stage_2_employee->id ?>','add_show_input_s2', 1)"  style=" border: 0px;background-color: #dec45c;color: #055837 !important;">
                                            <i class="bi bi-plus"></i></a>
                                        <!-- delete  -->
                                        <a class="btn btn-sm btn-danger disabled"><i class="bi bi-trash-fill"></i></a>
                                        <!-- comment  -->
                                        <a href="javascript:void(0)" class="btn btn-sm btn-sm btn_green_yellow" id="Dbtn_s2_Additional_<?= $stage_2_employee->id ?>" onclick="add_show_input_s2('Additional','<?= $stage_2_employee->id ?>')">
                                            <i class="bi bi-chat-left-dots"></i>
                                        </a>
                                        <a href="javascript:void(0)" class="btn btn-sm btn_yellow_green" style="display: none;" id="Xbtn_s2_Additional_<?= $stage_2_employee->id ?>" onclick="add_show_input_s2('Additional','<?= $stage_2_employee->id ?>')">
                                            <i class="bi bi-x-lg"></i>
                                        </a>
                                    </td>
                                    <td>
