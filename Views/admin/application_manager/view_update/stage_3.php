            ...
            <div class="accordion-body">
                <form action="" id="stage_3_change_status" method="post">
                    <table class="table table-striped border table-hover">
                        ...
                        <tr>
                            ...
                            if ($stage_3->status == "Submitted") {
                              ...
                              if ($session->admin_id == "1") {
                                ...
                                $app_select_3 = $log_select_3 = $log_active_3 =  $app_active_3 = $dec_active_3 = $with_active_3 = $sch_active_3 = $con_active_3 = $disabled;
                                $log_select_3 = $log_active_3 = "";
                                ...
                                $log_select_3 = $with_active_3 =  $log_active_3 = $app_active_3  = $pro_active_3 = $con_active_3 =  $dec_active_3 = $with_active_3 =  $disabled;
                                ...
                                // echo $log_active_3 ." ". $log_select_3;
                                // echo $disabled;
                                $log_select_3 = $with_active_3 =  $log_active_3 =  $pro_active_3 = $sch_select_3  = $con_select_3 = $disabled;
                                ...
                                $dec_active_3 = $log_select_3 = $with_active_3 =    $log_active_3 = $app_active_3 = $pro_active_3  = $sch_active_3 = $con_active_3 = $disabled;
                                ...
                                $dec_active_3 = $log_select_3 = $with_active_3 =  $pro_active_3  = $sch_active_3 = $con_active_3 = $app_active_3 =  $disabled;
                                ...
                                $log_select_3 = $with_active_3 =    $con_active_3 = $app_active_3 = $pro_active_3 = $sch_active_3 =  $disabled;
                                ...
                                $with_select_3 = "";
                                // $dec_active_3 = $with_active_3 = $log_active_3 = "";
                                // $pro_select_3 = $dec_select_3 = $log_select_3 = $sch_select_3 = $con_select_3 = "";
                            ...
                            if($session->admin_account_type == "head_office"){
                                $with_active_3 =    $con_active_3  = $pro_active_3 = $sch_active_3 = "disabled";    
                            }
                            ...
                            if($stage__cheking->pathway == "Pathway 1"){
                                if($stage__cheking->occupation_id == 7 || $stage__cheking->occupation_id == 18){
                                    if($session->admin_account_type == "head_office"){
                                        // Comment the code due to changes in exisitng code -> Mohsin
                            ...
                            if($session->admin_account_type == "head_office"){
                                if($stage__cheking->pathway == "Pathway 2"){
                                     $dec_active_3 = $app_active_3 = "disabled";
                                }
                            }
                        ...
                        <?php
                        $stage_1_details = find_one_row('stage_1_occupation', 'pointer_id', $stage_3->pointer_id); 
                       
                        if(($stage_1_details->occupation_id == 7 || $stage_1_details->occupation_id == 18)  && $stage_1_details->pathway == 'Pathway 1'){
                           //  print_r($stage_1_details);
                        ?>
                         <tr id="approval_comment_tr_stage_3" style="display: <?= ($stage_3->status == 'Approved') ? '' : 'none' ?>;">
                            ...
                            <td class="w-20">
                                <div style="display: flex;" class="position-relative">
                                    <textarea class="form-control" <?php
                                                                    ...
                                                                    ?> id="approval_comment_input_stage_3" name="approval_comment_stage_3" rows="3"><?php
                                                                                                                if ($stage_3->status == 'Approved') {

                                                                                                                    echo $stage_3->approved_comment;
                                    ...
                                    <a href="javascript:void(0)" id="stage_1_hide_show_btn_reson" style="vertical-align: bottom;" class="btn btn-sm btn_green_yellow position-absolute bottom-0 end-0" onclick="showReadOnly('#approval_comment_input_stage_3')">
