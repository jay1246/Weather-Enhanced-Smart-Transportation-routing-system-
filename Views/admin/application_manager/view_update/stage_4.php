<div class="accordion" id="flip-view_stage_4">
                    ...
                    <table class="table table-striped border table-hover">
                        ...
                        <tr>
                            ...
                            if ($stage_4->status == "Submitted") {
                                ...
                                $log_select_4 = $log_active_4 =  $app_active_4 = $dec_active_4 = $with_active_4 = $sch_active_4 = $con_active_4 = $disabled;
                                
                                
                                if($session->admin_account_type == "head_office"){
                                    $log_select_4 = "disabled";
                                }
                                ...
                                $dec_select_4 = $with_active_4 =    $log_active_4 = $app_active_4 = $pro_active_4  = $sch_active_4 = $con_active_4 = $disabled;
                                ...
                                $dec_active_4 = $log_select_4 = $with_active_4 =  $pro_active_4  = $sch_active_4 = $con_active_4 = $app_active_4 =  $disabled;
                            ...
                            if($session->admin_account_type == "head_office"){
                                $log_select_4 = $with_active_4 =    $con_active_4 = $app_active_4 = $pro_active_4 = $sch_active_4 = "disabled";    
                            }
                        ...
                        <tr>
                            ...
                            // print_r($value);
                                ...
                                $occ_id =  getOccupationID($stage_4->pointer_id,"no");
                             ?>
                        ...
                        <td class="w-20">
                            <div style="display: flex;" class="position-relative">
                                ...
                                <?php 
                                    ...
                                    if($session->admin_account_type == "admin"){
                                        ?>
                                <a href="javascript:void(0)" id="stage_4_hide_show_btn_reson" style="vertical-align: bottom;" class="btn btn-sm btn_green_yellow position-absolute bottom-0 end-0" onclick="readonlyInputs3('#comment_input_4')">
                    ...
                    <tr id="comment_tr_4">
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                <button type="submit" class="btn btn_green_yellow" id="s4_update" name="s4_update">Update</button>
                            </td>
                        </tr>
                    </table>
                </form>
