                                ...
                                <td class="w-20">
                                    ...
                                    <div class="row">
                                        ...
                                        if ($allocate_team_member_show) { ?>
                                            <div class="col-6">
                                                <select name="allocate_team_member_name" id="allocate_team_member_select_id" class="form-select" aria-label="Default select example">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <a id="stage_1_hide_show_btn_team_name_save" href="javascript:void(0)" onclick="stage_1_hide_show_btn_team_name_()" class="btn btn-sm btn_green_yellow my-auto hidden">
