            ...
            <div class="accordion-body">
                <form action="" id="stage_2_change_status" method="post">
                    <table class="table table-striped border table-hover">
                        ...
                        <tr id="approval_comment_tr_stage_2" style="display: <?= ($stage_2->status == 'Approved') ? '' : 'none' ?>;">
                            ...
                            <td class="w-20">
                                <div style="display: flex;" class="position-relative">
                                    <textarea class="form-control" <?php
                                                                    ...
                                                                    ?> id="approval_comment_input_stage_2" name="approval_comment_stage_2" rows="3"><?php
                                                                                                                if ($stage_2->status == 'Approved') {

                                                                                                                    echo $stage_2->approved_comment;
                                    ...
                                    <a href="javascript:void(0)" id="stage_1_hide_show_btn_reson" style="vertical-align: bottom;" class="btn btn-sm btn_green_yellow position-absolute bottom-0 end-0" onclick="showReadOnly('#approval_comment_input_stage_2')">
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                <?php if ($submit_btn_show) { ?>
                                    <button type="submit" class="btn btn_green_yellow" id="s2_update" name="s2_update">Update</button>
                                <?php } ?>
                            </td>
                        </tr>
                    </table>
