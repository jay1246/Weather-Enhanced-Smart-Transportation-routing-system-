    ...
    <section class="section dashboard mt-3 card shadow">
        ...
        <div class="row g-0 p-2">
            ...
            <div class="col-2 my-auto">
                    ...
                    <button onclick="add_flag_filter('upload')" class="flag_button grn_btn" id="green_flag_btn" type="button" style="border: 1px solid white;margin-left: 10px;"  data-toggle="tooltip" data-placement="top" title="Additional Information Received">
                        <img id="id_flag_green" class="filter_flag" src="<?= base_url() ?>/public/assets/icon/flag-green.png">
                    </button>
                    <button onclick="add_message_filter(this)" type="button" class="btn float-end message_btn_color_2" data-toggle="tooltip" data-placement="top" title="Assessor Comments" style="margin-top: 0px;font-size: 25px;padding: 3px 9px;">
...
<script>
    ...
    var is_active_message = 0;
    function add_message_filter(that){
        if(is_active_message == 0){
            is_active_message = 1;
            
            $(that).removeClass("message_btn_color_2");
            $(that).addClass("message_btn_color_1");
        }
        else if(is_active_message == 1){
            is_active_message = 0;
            
            $(that).removeClass("message_btn_color_1");
            $(that).addClass("message_btn_color_2");
        }
        add_comment_filter = is_active_message;
        
        load_data(page = 1);
        console.log(add_comment_filter);
    }
        ...
        function load_data(page = 1) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    add_comment_filter: add_comment_filter,
                },
