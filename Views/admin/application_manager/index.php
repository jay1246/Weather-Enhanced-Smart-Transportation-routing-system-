                    ...
                    <div class="table">
                        ...
                        <table id="staff_table" class="table table-striped datatable table-hover">
                            <div class="row flag_button_row float-end">
                               ...
                               if($filter_active){
                               ?>
                                <a href="<?= base_url("admin/applicant_agent/company/".$org->id."") ?>" class="onhover_pointer_btn message_box_icon message_btn_color_1" data-toggle="tooltip" data-placement="top" title="Assessor Comments">
                                ...
                                <?php 
                                   ...
                                   ?>
                                   <a href="<?= base_url("admin/applicant_agent/company/".$org->id."/show_comment_record") ?>" class="onhover_pointer_btn message_box_icon message_btn_color_2" data-toggle="tooltip" data-placement="top" title="Assessor Comments">
                                    <i class="bi bi-exclamation-lg"></i>
                                </a>
                                   <?php
                               }
...
<?php                    $s1_personal_details = find_one_row('stage_1_personal_details', 'pointer_id', $additional_info_request->pointer_id);
       ...
       <h5 class="modal-title text-center text-green"> <?= "[#" . $s1->unique_id . "] " . $s1_personal_details->first_or_given_name . " " . $s1_personal_details->middle_names . " " . $s1_personal_details->surname_family_name . " - " . $occupation_list->name . "" ?></h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="table">
                                                                    <style> .custom-class:nth-child(odd) {
                                                                                  /* Your styles for even elements with the custom-class */
                                                                        ...
                                                                        <tbody>
                                                                          ...
                                                                          // print_r($assesment_additional);
                                                                            ...
                                                                            <?php
                                                                             ...
                                                                             ?>
                                                                              <tr  id="<?= $tr_id ?>" class="custom-class">
                                                                            ...
                                                                            <?php if($reason['status'] == "upload"){ ?>
                                                                             <td><?= isset($reason['update_date']) ? date('d/m/Y', strtotime($reason['update_date'])) : 'N/A' ?></td>
                                                                              ...
                                                                              if($reason['status'] == "send"){?>
                                                                                <td>
                                                     <a  onclick="delete_additional_req(<?=$reason['id']?>,'#<?= $tr_id ?>','.<?= $td_class ?>','#<?=$remove_h?>',<?=$reason['pointer_id']?>);" class="btn btn-sm btn-danger ms-2">
                                                                          <i class="bi bi-x"></i>
                                                                          </a>
                                                                          </td>
                                                                          <?php }else{?>
                                                    ...
                                                    <?php } }?>
                                                                            ...
                                                                            ?>
                                                                                 ...
                                                                                 <tr  id="<?= $tr_id_support ?>" class="custom-class">
                                                                      ...
                                                                      <td>
                                                                            ...
                                                                            <?php if($reasons['status'] == "upload"){ ?>
                                                                             <td><?= isset($reasons['update_date']) ? date('d/m/Y', strtotime($reasons['update_date'])) : 'N/A' ?></td>
                                                                              ...
                                                                              <td>
                                                                 <a onclick="delete_additional_req(<?=$reasons['id']?>,'#<?= $tr_id_support ?>','.<?= $td_class_support ?>','#<?=$remove_h?>',<?=$reasons['pointer_id']?>)" class="btn btn-sm btn-danger ms-2">
                                                                                  <i class="bi bi-x"></i>
                                                                                  </a>
                                                                                  </td>
                                                                                 <?php }else{?>
                                                                           ...
                                                                           <td colspan="6" class="text-success " id="<?=$remove_h?>"><b><?=$organisation__['company_organisation_name']?></b></td>
                                                                             ...
                                                                             $suborganisation__docs= find_one_row('documents', 'id',$suborganisation__['document_id']);
                                                                                ...
                                                                                $td_class = "rearrange_td__".$suborganisation__["pointer_id"].$suborganisation__['s2_add_employment_id'];
                                                                                    ?>
                                                                             <tr data-id="<?=$c?>" id="<?= $tr_id ?>" class="custom-class">
                                                 ...
                                                 <a  onclick="delete_additional_req(<?=$suborganisation__['id']?>,'#<?= $tr_id ?>','.<?= $td_class ?>','#<?=$remove_h?>',<?=$suborganisation__['pointer_id']?>)" class="btn btn-sm btn-danger ms-2">
                                                                                      ...
                                                                                      <?php }else{?>
                                                                   <td>
                                                               <button class="btn btn-sm btn-danger ms-2" disabled><i class="bi bi-x"></i></a>
                                                                 </td>
                                                    <?php } }?>
                                                                            </tr>
                                                                                  <?php
                                                                          ...
                                                                          //  $additional_infos = find_multiple_rows('additional_info_request', 'pointer_id', $value['pointer_id']);
                                                                            ...
                                                                            $delete_id_for_refer++;
                                                                                ...
                                                                                <tr data-record-id="<?=$sr?>" id="<?= $tr_id ?>" class="custom-class">
                                                                           ...
                                                                           <?php if($val['status'] == "upload"){ ?>
                                                                             ...
                                                                             <?php 
                                                                              ...
                                                                              if($val['status'] == "send"){?>
                                                                             <td>
                                                                <a onclick="delete_additional_request(<?=$val['id']?>,<?=$sr?>, '#<?= $tr_id ?>','.<?= $td_class ?>',1,<?=$val['pointer_id']?>)" class="btn btn-sm btn-danger ms-2">
                                                                                  <i class="bi bi-x"></i>
                                                                                  </a>
                                                                                  </td>
                                                                                  <?php }else{?>
