...
<style>
    ...
    .message_btn_color_1,.message_btn_color_2:hover{
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h4 style="color: #055837;">Dashboard</h4>
    </div><!-- End Page Title -->
            ...
            <div class="card shadow">
                <div class="card-body" style="    padding: 0;">
                    <div class="table">
                        ...
                        <table id="dash_tab" class="table table-striped">

                            <div class="row flag_button_row float-end">
                               <?php 
                               if($filter_active){
                               ?>
                                <a href="<?= base_url("admin/dashboard") ?>" class="onhover_pointer_btn message_box_icon message_btn_color_1" data-toggle="tooltip" data-placement="top" title="Assessor Comments">
                                ...
                                <?php 
                                   ...
                                   ?>
                                   <a href="<?= base_url("admin/dashboard/show_comment_record") ?>" class="onhover_pointer_btn message_box_icon message_btn_color_2" data-toggle="tooltip" data-placement="top" title="Assessor Comments">
                                    <i class="bi bi-exclamation-lg"></i>
                                </a>
                                   <?php
                               }
                                ...
                                <button class="col-md flag_button grn_btn" id="green_flag_btn" type="button" style="border: 1px solid white;">
                                    <img id="id_flag_green" class="filter_flag" data-toggle="tooltip" data-placement="top" title="Additional Information Received" src="<?= base_url("public/assets/icon/flag-green.png") ?>">
                                </button>
                                <button class="col-md flag_button red_btn" id="red_flag_btn" data-toggle="tooltip" data-placement="top" title="Additional Information Requested" type="button" style="border: 1px solid white;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <?php } ?>
                                    <th style="width:8%">Applicant No.</th>
                                    ...
                                    ?>
                                    <th style="width:2%; text-align: center;">TM</th>
                                    <?php 
                                    }
                                    ?>
                                </tr>
                            ...
                            <tbody>
                                ...
                                foreach ($all_list as $key => $value) {
                                    ...
                                    $s1_occupation_above = find_one_row('stage_1_occupation', 'pointer_id', $value["pointer_id"]);
                                    // print_r($value);
                                    // exit;
...
<h5 class="modal-title text-center text-green"> <?= "[#" . $s1->unique_id . "] " . $s1_personal_details->first_or_given_name . " " . $s1_personal_details->middle_names . " " . $s1_personal_details->surname_family_name . " - " . $occupation_list->name . "" ?></h5>
                                                                           ...
                                                                           <?php if($suborganisation__['status'] == "upload"){ ?>
                                                                             ...
                                                                             <?php 
                                                                              ...
                                                                              <?php }?>
                                                                               <?php 
                                                                                if (session()->get('admin_account_type') == 'admin') {
                                                                               if($suborganisation__['status'] == "send"){?>
                                                                                                         <td>
                                        ...
                                        <td>
                                            <?php                                            
                                            $is_Show = getTheCurrentMessageStatusThere($value['pointer_id']);
                                            if($is_Show){
                                            ?>
                                            <a onclick="__openTheAlertMessage(<?= $value['pointer_id'] ?>)" class="onhover_pointer" style="color: #009933;">
                                                <?= $value['unique_id'] ?>
                                            </a>
                                            <?php 
                                            }
                                        ...
                                        <td>
                                            <a style="color:#009933" href="<?= base_url('admin/application_manager/view_application') ?>/<?= $value['pointer_id'] ?>/view_edit">
                                        ...
                                        <td>
                                            ...
                                            // print_r($value);
                                            // die;
                                            echo getTheTeamMemberNameTBA($value["team_member"]);
...
<?php 
include "application_manager/comment_popup_box_logic.php";
?>
...
<script>
    $(document).ready(function() {
        ...
        console.log('dash_tab');
        $('.dataTables_filter').addClass('pull-up');



        // document.getElementById("red_flag_btn").addEventListener("click", function() {
        //     console.log('F_red');
        ...
        //     }
        // });
        // document.getElementById("green_flag_btn").addEventListener("click", function() {
        ...
        $('#red_flag_btn').click(function() {
            ...
            if (red_flag.attr('class') == "col-md flag_button red_btn active_flag") {
                ...
                if (green_flag.attr('class') == "col-md flag_button grn-btn active_flag") {
                    green_flag.removeClass("active_flag");
                    green_flag.css("background-color", "#F0F0F0");
